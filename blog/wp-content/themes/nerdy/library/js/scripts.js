...
jQuery(document).ready(function($) {
    ...
    */
    ...
    /* if is below 767px (tablet or smaller) */
    if (responsive_viewport < 767) {
    	jQuery('.mobile_nav_btn').click(function(){
    		jQuery('.menu ul, .top-nav').slideToggle();
    	});
    } /* end smallest screen */
    ...
    if (responsive_viewport >= 768) {
		...
		jQuery('#main_menu ul li').hover(function(){
			...
			jQuery(this).find('.sub-menu').stop(true, true).slideUp('fast');
		});
		
		jQuery('#main_menu ul li:last-child').find('.sub-menu').css({ 'right' : '0' });
	...
	jQuery(window).load(function(){
		var first_gallery_image_height = jQuery('.rotator-gallery img:first').height();
		var first_gallery_image_width = jQuery('.rotator-gallery img:first').width();
		jQuery('.rotator-gallery').css({ 'height': first_gallery_image_height, 'width' : first_gallery_image_width });

		
		jQuery('.rotator-gallery').each(function() {
			jQuery('.rotator-gallery').cycle({
				pause: 1,
				next: '.next',
				prev: '.prev',
				speed: 300
	...
	///////////////////////////////////
	var link_type_url = jQuery('.type-link a').attr('href');
	jQuery('.type-link-small').html(link_type_url);
	...
	//tooltip stripe
	///////////////////////////////////
	jQuery('.tooltip_link').hover(function(){
		jQuery(this).prev().fadeIn('fast');
	}, function(){
		jQuery(this).prev().fadeOut('fast');
	});

	jQuery('.jobstitle').hover(function(){
		jQuery(this).find('.ccmsExcerpt').fadeIn('fast');
	}, function(){
		jQuery(this).find('.ccmsExcerpt').fadeOut('fast');
	});

	///////////////////////////////////
	//zebra stripe
	///////////////////////////////////
	jQuery('.zebra tr:odd').addClass('alt');
	
	
	
	///////////////////////////////////
	//bring the scroll nav down
	///////////////////////////////////
	jQuery('#logo').waypoint(function(event, direction) {
		if (direction === 'down') {
	   		jQuery('#header').animate({ 'margin-top' : '-10'  });
	   	}else{
	   		jQuery('#header').animate({ 'margin-top' : '-70'  });
	   	}
	...
	//alerts
	///////////////////////////////////
	jQuery('.help, .info, .error, .success').click(function(){
		jQuery(this).fadeOut();
	});
	...
	//accordion
	///////////////////////////////////
	jQuery('.accordionContent div:first').show();
	jQuery('.accordionTitle:first').addClass('first').addClass('selected');
	jQuery('.accordionContent div:last').parent().addClass('end');
	...
	jQuery('.accordionTitle').click(function(){
		...
		if( jQuery(this).hasClass('selected') ){
			...
			jQuery('.accordionContent div').slideUp('fast');
			jQuery(this).next().find('div').slideDown('fast');
	...
	//tabs
	///////////////////////////////////
	jQuery('.panes .pane').first().show();	//show first pane
	jQuery('.tabs li').eq(0).addClass('selected');
	
	jQuery('.tabs li').click(function(e){
		e.preventDefault();
		jQuery('.tabs li').not(this).removeClass('selected');
		jQuery(this).addClass('selected');
		
		var whichTab = jQuery(this).index();
		
		jQuery('.panes .pane').hide();
		jQuery('.panes .pane').eq(whichTab).show();
	});
...
/** jQuery Plugins Go Down Here to Reduce HTTP Requests **/
/*!
